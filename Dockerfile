...
RUN uv pip install comfyui-liveportraitkj@git+https://github.com/samhodge-aiml/ComfyUI-LivePortraitKJ/@4215dcd6ba8d6b444ddc4c6a5815425031809fe2 --break-system-packages
