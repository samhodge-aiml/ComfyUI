...
RUN uv pip install comfyui-hunyuanvideowrapper@git+https://github.com/samhodge-aiml/ComfyUI-HunyuanVideoWrapper@b6aae40765b98f7dcd8379dae2e616239104c20a --break-system-packages 
